...
(function () {
  ...
  const translations = {
    en: {
      ...
      'contact.hours': 'Hours',
      'contact.hours.value': 'Sun - Fri: 7:00 AM - 5:00 PM',
      'contact.social': 'Social Media',
      'why.big.label': "Visa success rate — Pokhara's best",
      'why.mini1.num': '5K',
      'why.mini1.label': 'Students placed',
      'why.mini2.num': '12',
      'why.mini2.label': 'Top Cities',
      'why.mini3.num': '100',
      'why.mini3.label': 'Partner universities',
      'why.mini4.label': 'Post-visa support',
    ...
    ja: {
      ...
      'contact.hours': '営業時間',
      'contact.hours.value': '日〜金：7:00 AM - 5:00 PM',
      'contact.social': 'SNS',
      'why.big.label': 'ビザ成功率 — ポカラNo.1',
      'why.mini1.num': '5K',
      'why.mini1.label': '送り出した学生数',
      'why.mini2.num': '12',
      'why.mini2.label': 'トップ都市',
      'why.mini3.num': '100',
      'why.mini3.label': '提携大学',
      'why.mini4.label': '渡航後もサポート',
      'social.facebook': '📘 Facebook',
      'social.instagram': '📸 Instagram',
      'social.youtube': '▶️ YouTube',
      'social.tiktok': '🎵 TikTok',
    ...
    ne: {
      ...
      'contact.hours': 'समय',
      'contact.hours.value': 'आइतबार - शुक्रबार: बिहान ७:०० - साँझ ५:००',
      'contact.social': 'सामाजिक सञ्जाल',
      'why.big.label': 'भिसा सफलता दर — पोखरामा सर्वोत्कृष्ट',
      'why.mini1.num': '5K',
      'why.mini1.label': 'विद्यार्थी पठाइएका',
      'why.mini2.num': '12',
      'why.mini2.label': 'शीर्ष शहरहरू',
      'why.mini3.num': '100',
      'why.mini3.label': 'साझेदार विश्वविद्यालय',
      'why.mini4.label': 'भिसापछिको सहयोग',
      'social.facebook': '📘 Facebook',
      'social.instagram': '📸 Instagram',
      'social.youtube': '▶️ YouTube',
      'social.tiktok': '🎵 TikTok',
  ...
  const bindings = [
    ...
    { selector: '.why-big-label', key: 'why.big.label' },
    { selector: '.why-mini-card:nth-child(1) .why-mini-label', key: 'why.mini1.label' },
    { selector: '.why-mini-card:nth-child(2) .why-mini-label', key: 'why.mini2.label' },
    { selector: '.why-mini-card:nth-child(3) .why-mini-label', key: 'why.mini3.label' },
    { selector: '.why-mini-card:nth-child(4) .why-mini-label', key: 'why.mini4.label' },
    ...
    { selector: '#contact .info-item:nth-child(3) .info-label', key: 'contact.email' },
    { selector: '#contact .info-item:nth-child(4) .info-label', key: 'contact.phone' },
    { selector: '#contact .info-item:nth-child(5) .info-label', key: 'contact.hours' },
    { selector: '#contact .info-item:nth-child(5) .info-value', key: 'contact.hours.value' },
    ...
    { selector: '.contact-form .submit-btn', key: 'form.submit' },
