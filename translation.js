...
(function () {
  ...
  const translations = {
    en: {
      ...
      'benefits.card1.title': 'Personalized Support',
      'benefits.card1.desc': 'Dedicated expert guidance tailored to your unique goals and circumstances throughout your entire journey.',
      'benefits.card2.title': 'Payment After Getting Visa',
      'benefits.card2.desc': 'Pay only after your visa is approved. No upfront fees — we succeed when you succeed.',
    ...
    ja: {
      ...
      'benefits.card1.title': '一人ひとりに合ったサポート',
      'benefits.card1.desc': 'あなたの目標や状況に合わせた専任の専門家が、留学の全行程を通じて丁寧にサポートします。',
      'benefits.card2.title': 'ビザ取得後のお支払い',
      'benefits.card2.desc': 'ビザが承認されてからのお支払い。前払い費用なし — あなたの成功が私たちの成功です。',
      'contact.tag': 'お問い合わせ',
    ...
    ne: {
      ...
      'benefits.card1.title': 'व्यक्तिगत सहयोग',
      'benefits.card1.desc': 'तपाईंको लक्ष्य र परिस्थिति अनुसार समर्पित विशेषज्ञ मार्गदर्शन, सम्पूर्ण यात्राभर।',
      'benefits.card2.title': 'भिसा पाएपछि मात्र भुक्तानी',
      'benefits.card2.desc': 'भिसा स्वीकृत भएपछि मात्र भुक्तानी गर्नुहोस्। अग्रिम शुल्क छैन — तपाईंको सफलता नै हाम्रो सफलता हो।',
  ...
  const bindings = [
    ...
    { selector: '.nav-links li:nth-child(4) a', key: 'nav.team' },
    { selector: '.nav-links li:nth-child(5) a', key: 'nav.stories' },
    { selector: '.nav-links li:nth-child(6) a', key: 'nav.gallery' },
    { selector: '.nav-links li:nth-child(7) a', key: 'nav.contact' },
    ...
    { selector: '#benefits .benefit-card:nth-child(1) .benefit-title', key: 'benefits.card1.title' },
    { selector: '#benefits .benefit-card:nth-child(1) .benefit-desc', key: 'benefits.card1.desc' },
    { selector: '#benefits .benefit-card:nth-child(2) .benefit-title', key: 'benefits.card2.title' },
    { selector: '#benefits .benefit-card:nth-child(2) .benefit-desc', key: 'benefits.card2.desc' },
