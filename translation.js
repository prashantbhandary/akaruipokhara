...
(function () {
  ...
  const translations = {
    en: {
      ...
      'hero.sub': "AKARUI! guides students from Nepal toward world-class universities. From counselling to visa — we're with you every step of the journey.",
      ...
      'services.card6.title': 'Accommodation Help',
      'services.card6.desc': 'Comprehensive coaching for JLPT (Japanese Language Proficiency Test) and NAT-TEST, while still offering IELTS, PTE, and TOEFL support for students targeting English-medium programs in Japan.',
    ...
    ja: {
      ...
      'hero.sub': 'AKARUI! はネパールの学生を世界水準の大学へ導きます。カウンセリングからビザ取得まで、すべてのステップを伴走します。',
      ...
      'services.card6.title': '宿泊・住居サポート',
      'services.card6.desc': '日本語学校向けのJLPT/NAT-TEST対策から、英語圏向けの英語コーチングまで幅広く対応。',
      'process.tag': 'ご利用の流れ',
    ...
    ne: {
      ...
      'hero.sub': 'AKARUI! ले नेपाली विद्यार्थीलाई विश्वस्तरीय विश्वविद्यालयतर्फ मार्गदर्शन गर्छ। काउन्सिलिङदेखि भिसासम्म, हामी प्रत्येक चरणमा साथ हुन्छौं।',
      ...
      'services.card6.title': 'आवास सहयोग',
      'services.card6.desc': 'जापानमा बसोबासका लागि आवास खोज, प्रारम्भिक सेटअप र स्थानीय मार्गदर्शन सहयोग।',
